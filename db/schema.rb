...
ActiveRecord::Schema.define(version: 2026_07_26_034504) do
  ...
  create_table "chat_messages", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["quoted_chat_message_id"], name: "index_chat_messages_on_quoted_chat_message_id"
    t.index ["reply_to_chat_message_id"], name: "index_chat_messages_on_reply_to_chat_message_id"
  end
  ...
  create_table "learning_assignments", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["learning_student_id", "learning_student_training_id", "status"], name: "index_learning_assignments_on_student_training_status"
    ...
    t.index ["learning_student_training_id"], name: "index_learning_assignments_on_student_training_id"
    t.index ["reviewed_by_id"], name: "index_learning_assignments_on_reviewed_by_id"
  ...
  create_table "pending_stripe_checkouts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "singing_generated_recap_movies", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.json "generated_props"
    t.datetime "cleaned_up_at"
    t.string "share_token"
    t.boolean "share_enabled", default: true, null: false
    t.index ["cleaned_up_at"], name: "index_singing_generated_recap_movies_on_cleaned_up_at"
    ...
    t.index ["share_token"], name: "index_singing_generated_recap_movies_on_share_token", unique: true
  ...
  create_table "singing_recap_movie_batch_executions", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "actual_created_movies_count", default: 0, null: false
    t.integer "actual_regenerated_movies_count", default: 0, null: false
    t.integer "actual_skipped_movies_count", default: 0, null: false
