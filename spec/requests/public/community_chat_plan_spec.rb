...
RSpec.describe "コミュニティチャットの閲覧・投稿権限のテスト", type: :request do
  ...
  # community_createはコミュニティ参加権限をCommunityCustomerで検証する(Chat::ChatRoomAuthorization)ため、
  # ChatRoomCustomerだけでなくCommunityCustomerとしても登録しておく。
  let!(:member_community_customer) { CommunityCustomer.find_or_create_by!(customer: customer, community: community) }
