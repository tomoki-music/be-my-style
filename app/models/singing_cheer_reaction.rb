class SingingCheerReaction < ApplicationRecord
  NOTIFICATION_ACTION_PREFIX = "singing_cheer_reaction_".freeze

  REACTION_TYPES = %w[fire clap sing sparkle].freeze
  ...
  def create_notification
    target_customer.create_notification_singing_cheer_reaction(customer, reaction_type)
  end
end
