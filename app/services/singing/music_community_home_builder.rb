  ...
  class MusicCommunityHomeBuilder
    ...
    def call
      ...
      MusicCommunityHome.new(
        ...
        gentle_return_flow: Singing::GentleReturnFlowBuilder.call(@customer),
        community_memory: Singing::CommunityMemoryBuilder.call(@customer),
        personal_music_story: Singing::PersonalMusicStoryBuilder.call(@customer),
        music_milestones: Singing::MusicMilestonesBuilder.call(@customer),
        community_recommendation: Singing::CommunityRecommendationBuilder.call(@customer),
        return_motivation: Singing::ReturnMotivationBuilder.call(@customer),
        music_friends: Singing::MusicFriendsBuilder.call(@customer),
        friend_activity_highlights: Singing::FriendActivityHighlightsBuilder.call(@customer),
