  ...
  class AiCommentGenerator
    ...
    PERFORMANCE_TYPE_INSTRUCTIONS = {
      "vocal" => [
        ...
        "expression_scoreは、音量の変化幅など録音から測れる範囲の抑揚の目安として扱ってください。ビブラートの質や語尾のニュアンスなど、録音から直接測れない要素まで測定したかのようには表現しないでください。"
      ],
      "guitar" => [
        ...
        "expression_scoreは、アタックのコントロールやミュート、音量の変化幅など演奏のタッチに基づく表現の目安として扱ってください。歌声の抑揚やビブラートとしては解釈しないでください。",
      ...
      "bass" => [
        ...
        "expression_scoreは、アタックのコントロール・音の長さ・安定感・音量の変化幅など演奏面の表現の目安として扱ってください。歌声の抑揚やビブラートとしては解釈しないでください。",
        "specific_comparisonがある場合は、同じ補足スコアの前回比を成長や振り返りの目安として自然に触れてください。",
        "vocal固有の歌声、喉、ミックスボイス、発音、声量といった表現は使わないでください。",
      ...
      "drums" => [
        ...
        "expression_scoreは、強弱の付け方やアタックのコントロールなど演奏面の表現の目安として扱ってください。歌声の抑揚やビブラートとしては解釈しないでください。",
      ...
      "keyboard" => [
        ...
        "expression_scoreは、タッチや音のつながり、音量の変化幅など演奏面の表現の目安として扱ってください。歌声の抑揚やビブラートとしては解釈しないでください。",
